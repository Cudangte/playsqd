...
@Table(MusicDirectoryScanLogEntity.TABLE_NAME)
public class MusicDirectoryScanLogEntity extends AuditableEntity {

    public static final String TABLE_NAME = "MUSIC_DIRECTORY_SCAN_LOG";
